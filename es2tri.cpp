...
static float view_rotx = 0.0, view_roty = 0.0;
...
static void
make_z_rot_matrix(float angle, float *m)
{
...
static void
make_scale_matrix(float xs, float ys, float zs, float *m)
{
	int i;
	for (i = 0; i < 16; i++)
		m[i] = 0.0;
...
static void
mul_matrix(float *prod, const float *a, const float *b)
{
...
main(int argc, char *argv[])
{
  ...
  XEventHelper eventHelper(x_dpy); 
  
  eventHelper.startListener(); 
